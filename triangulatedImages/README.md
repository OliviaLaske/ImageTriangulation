...
![Image convolution process for x-direction](/readmeImages/blueToGrey.png){width=50%}
...
### 4. Apply Sobel Operator
![Image after Sobel operator is applied](/readmeImages/tajMahal_sobel.jpg){width=50%}
